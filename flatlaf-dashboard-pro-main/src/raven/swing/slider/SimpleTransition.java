...
/**
 * SimpleTransition es una clase que proporciona métodos estáticos para crear
 * diferentes tipos de transiciones utilizadas en el componente PanelSlider para
 * animar cambios entre componentes.
 *
 * @author Esteban
 */
public class SimpleTransition {
    ...
    /**
     * Obtiene una transición predeterminada para desplazarse hacia la derecha o
     * izquierda.
     *
     * @param toRight Indica si la transición es hacia la derecha.
     * @return La transición predeterminada.
     */
    ...
    /**
     * Obtiene una transición para mostrar el menú lateral.
     *
     * @param drawerWidth El ancho del cajón lateral (drawer).
     * @return La transición para mostrar el menú.
     */
    ...
    /**
     * Obtiene una transición para ocultar el menú lateral.
     *
     * @param drawerWidth El ancho del cajón lateral (drawer).
     * @return La transición para ocultar el menú.
     */
    ...
    /**
     * Obtiene una transición para cambiar entre formularios.
     *
     * @param oldFormImage La imagen del formulario antiguo.
     * @param drawerWidth El ancho del cajón lateral (drawer).
     * @return La transición para cambiar entre formularios.
     */
    ...
    // Métodos y detalles de implementación adicionales...
